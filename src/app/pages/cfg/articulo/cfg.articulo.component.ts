...
@Component({
  selector: 'app-cfg-articulo',
  templateUrl: './cfg.articulo.component.html',
  providers: [FormsModule, ReactiveFormsModule, ScriptLoaderService, MapeoService, ConceptoService]
})
export class CfgArticuloComponent implements OnInit, AfterViewInit {
  public title: string;

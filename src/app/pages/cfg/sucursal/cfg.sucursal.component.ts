...
@Component({
  selector: 'app-cfg-sucursal',
  templateUrl: './cfg.sucursal.component.html',
  providers: [FormsModule, ReactiveFormsModule, ScriptLoaderService, MapeoService, ConceptoService]
})
export class CfgSucursalComponent implements OnInit, AfterViewInit {
  public title: string;
